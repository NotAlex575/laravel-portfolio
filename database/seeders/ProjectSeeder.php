...
class ProjectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach($projects as $project){
            ...
            $newProject->nome = $projects['nome'];
            $newProject->cliente = $projects['cliente'];
            $newProject->periodo_inizio = $projects['periodo_inizio'];
            $newProject->riassunto = $projects['riassunto'];
            $newProject->save();
        }
